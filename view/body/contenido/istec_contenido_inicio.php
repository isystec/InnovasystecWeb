...
?>
    ...
    <div class="container mb-5 mt-4">
        ...
        <div class="card-deck">
            <div class="card">
                <img src="./img/card-hosting.jpg" class="card-img-top" alt="...">
                <div class="card-body text-center">
                    <h5 class="card-title negrita">Hosting</h5>
                    <p class="card-text">Ideal para aquellos que desean iniciar un sitio web en Internet y precisan una herramienta sencilla de utilizar ademas de fácil administración.</p>
                </div>
            </div>
            <div class="card">
                <img src="./img/card-dominio.jpg" class="card-img-top" alt="...">
                <div class="card-body text-center">
                    <h5 class="card-title negrita">Dominios</h5>
                    <p class="card-text">Único, exclusivo e indispensable para un sitio web ya que a través de él identificarán tu marca y reconocerán su valor e importancia.</p>
                </div>
            </div>
            <div class="card">
                <img src="./img/card-desarrolloweb.jpg" class="card-img-top" alt="...">
                <div class="card-body text-center">
        ...
        <div class="card-deck">
            <div class="card">
                <img src="./img/card-redes.jpg" class="card-img-top" alt="...">
                <div class="card-body text-center">
            ...
            <div class="card">
                <img src="./img/card-sistemas.jpg" class="card-img-top" alt="...">
                <div class="card-body text-center">
            ...
            <div class="card">
                <img src="./img/card-consultoria.jpg" class="card-img-top" alt="...">
                <div class="card-body text-center">
